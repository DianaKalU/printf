 ...
 * @types: arguments list
 * @buffer:  handle print
 * @flags:  Calculation of all the active flags
 * @width: get width.
 * @precision:  specifications
 * @size: specifies the size
...
/**
 * print_binary - Prints an unsigned nber
 * @types: arguments list
 * @buffer:  handle print
 * @flags:  Calculates of all the active flags
 * @width: get width.
 * @precision:  specifications
 * @size:  specifies the size 
 * Return: Numbers  of all the  printed characters.
 */
